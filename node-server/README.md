...
[drone graffiti vue.js frontend](https://github.com/aeternity/aepp-drone-painting/tree/master/aepp) and allows for 
[sanity checking bids](https://github.com/aeternity/aepp-drone-painting/blob/master/node-server/docs/SANITY.md).

## Setup

Clone this repository by running
```
git clone git@github.com:aeternity/aepp-drone-painting.git
```
Install the dependencies
```
cd aepp-drone-painting/node-server && npm install
```
